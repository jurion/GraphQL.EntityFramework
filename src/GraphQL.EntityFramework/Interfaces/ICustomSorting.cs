...
public interface ICustomSorting<TItem>
{
    ...
    /// <param name="context">Resolver context</param>
    ...
    /// <param name="ordered">Ordered</param>
    /// <returns>The query with sorting applied</returns>
    bool ApplySort(IQueryable<TItem> query, OrderBy orderBy, IResolveFieldContext context, bool isFirst, out IOrderedQueryable<TItem> ordered);
